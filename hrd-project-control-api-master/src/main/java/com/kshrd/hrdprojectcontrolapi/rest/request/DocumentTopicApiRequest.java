...
public class DocumentTopicApiRequest {
    private String name;
...
//    private float percentage;
    ...
    public DocumentTopicApiRequest() {
    }

    public DocumentTopicApiRequest(String name, String startDate, String endDate, int projectScheduleId, Boolean status, int id) {
        this.name = name;
    ...
    public String toString() {
        return "DocumentTopicApiRequest{" +
                "name='" + name + '\'' +
                ", startDate='" + startDate + '\'' +
                ", endDate='" + endDate + '\'' +
